...
class YAMLProvider implements Provider {
    ...
    {
        if (!file_exists(Main::getInstance()->getDataFolder() . "groups.yml",)){
            Main::getInstance()->saveResource("groups.yml");
        }
        return new Config(Main::getInstance()->getDataFolder() . "groups.yml");
    }
    ...
    public function getPlayersData(): Config
    {
        ...
        return new Config(Main::getInstance()->getDataFolder() . "players.yml");
    }
